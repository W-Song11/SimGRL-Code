...
def parse_args():
    ...
    parser.add_argument('--action_repeat', default=4, type=int) #finger 2, cartpole 8, else 4
    parser.add_argument('--episode_length', default=1000, type=int)
    parser.add_argument('--eval_mode', default='video_hard', type=str)
	
	# agent
    parser.add_argument('--algorithm', default='simgrl', type=str)
    ...
    #sgqn
    parser.add_argument("--sgqn_quantile", default=0.98, type=float)
    ...
    assert args.algorithm in {'sac', 'rad', 'curl', 'pad', 'soda', 'drq', 'svea', 'sgsac', 'tlda', 'simgrl', 'simgrl-F', 'simgrl-S'}, f'specified algorithm "{args.algorithm}" is not supported'
